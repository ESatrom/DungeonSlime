...
public class TitleScene : Scene
{
    ...
    public override void LoadContent()
    {
        ...
        _titleFont = Content.Load<SpriteFont>("fonts/04B_30_5x");
    ...
    public override void Draw(GameTime gameTime)
{
    ...
    if (_titleScreenButtonsPanel.IsVisible)
    {
        ...
        Core.SpriteBatch.DrawString(_titleFont, DUNGEON_TEXT, _dungeonTextPos, Color.White, 0.0f, _dungeonTextOrigin, 1.0f, SpriteEffects.None, 1.0f);
        ...
        Core.SpriteBatch.DrawString(_titleFont, SLIME_TEXT, _slimeTextPos, Color.White, 0.0f, _slimeTextOrigin, 1.0f, SpriteEffects.None, 1.0f);
